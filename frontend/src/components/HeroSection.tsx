...
const HeroSection = () => {
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0f1117] pt-20">
            {/* Grid Background */}
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-left space-y-8 max-w-2xl">
                        {/* Badge */}
                        <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 text-primary-foreground/90 px-4 py-2 rounded-full backdrop-blur-sm animate-fade-in hover:bg-white/10 transition-colors cursor-default">
                            <Sparkles className="w-4 h-4 text-amber-400" />
                            <span className="text-sm font-medium text-gray-200">Decentralized Rental Platform</span>
                        </div>
                        ...
                        {/* Subheading */}
                        <p className="text-lg sm:text-xl text-gray-400 leading-relaxed max-w-lg animate-slide-up" style={{ animationDelay: "0.1s" }}>
                            Book unique stays directly with hosts using smart contracts on the Stacks blockchain.
                            No intermediaries, lower fees, and complete transparency.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 animate-slide-up" style={{ animationDelay: "0.2s" }}>
                            ...
                            <Button size="lg" variant="outline" className="w-full sm:w-auto border-white/10 bg-white/5 text-white hover:bg-white/10 hover:text-white h-14 px-8 rounded-xl text-lg font-semibold backdrop-blur-sm transition-all">
                                Learn More
                            </Button>
                        </div>

                        {/* Stats */}
                        <div className="grid grid-cols-3 gap-8 pt-8 border-t border-white/10 animate-fade-in" style={{ animationDelay: "0.3s" }}>
                            <div>
                    ...
                    <div className="relative hidden lg:block h-[600px] w-full animate-fade-in" style={{ animationDelay: "0.4s" }}>
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                            <div className="relative w-32 h-32 bg-[#1a1d26] border border-white/10 rounded-3xl flex items-center justify-center shadow-2xl shadow-orange-500/10 z-20">
                            ...
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 border border-white/5 rounded-full animate-pulse opacity-10"></div>
                        </div>

                        {/* Connecting Lines (SVG) */}
                        <svg className="absolute inset-0 w-full h-full z-0 pointer-events-none">
                            {/* Lines connecting center to nodes */}
                            <path d="M300 300 L150 150" className="stroke-white/10 stroke-2" strokeDasharray="4 4" />
                            <path d="M300 300 L450 150" className="stroke-white/10 stroke-2" strokeDasharray="4 4" />
                            <path d="M300 300 L150 450" className="stroke-white/10 stroke-2" strokeDasharray="4 4" />
                            <path d="M300 300 L450 450" className="stroke-white/10 stroke-2" strokeDasharray="4 4" />
                        </svg>

                        {/* Node 1: Wallet */}
                        <div className="absolute top-[20%] left-[20%] animate-float" style={{ animationDelay: "0s" }}>
                            <div className="bg-[#1a1d26] p-4 rounded-2xl border border-white/10 shadow-xl flex items-center gap-3">
                                <div className="w-10 h-10 bg-emerald-500/20 rounded-xl flex items-center justify-center">
                                    <Wallet className="w-5 h-5 text-emerald-400" />
                                </div>
                                <div>
                                    <div className="text-white font-semibold text-sm">Connect</div>
                                    <div className="text-xs text-gray-500">Secure Wallet</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="absolute top-[20%] right-[20%] animate-float" style={{ animationDelay: "1.5s" }}>
                            <div className="bg-[#1a1d26] p-4 rounded-2xl border border-white/10 shadow-xl flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-gray-500">Find Homes</div>
                                </div>
                            </div>
                        </div>
